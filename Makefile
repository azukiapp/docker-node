all:
	adocker build -t azukiapp/node:latest 4.2.1
	adocker build -t azukiapp/node:4.2.1 4.2.1
	adocker build -t azukiapp/node:4.2 4.2.1
	adocker build -t azukiapp/node:4 4.2.1
...
no-cache:
	adocker build --rm --no-cache -t azukiapp/node:latest 4.2.1
	adocker build --rm --no-cache -t azukiapp/node:4.2 4.2.1
	adocker build --rm --no-cache -t azukiapp/node:4 4.2.1
